...
expName = 'pilot_v7.2'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/nursimaunver/Memory ryhthms/ltm-att-exp/pilot_v7.2_lastrun.py',
...
for thisTrials_out in trials_out:
    ...
    # set up handler to look after randomisation of conditions etc
    trials_in = data.TrialHandler(nReps=1, method='sequential', 
        extraInfo=expInfo, originPath=-1,
    ...
    # completed 1 repeats of 'trials_in'
