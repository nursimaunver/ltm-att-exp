...
expName = 'pilot_v6'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/nursimaunver/Memory ryhthms/ltm-att-exp/pilot_v6_lastrun.py',
...
# set up handler to look after randomisation of conditions etc
trials_prac2 = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('cond.xlsx'),
...
for thisTrials_prac2 in trials_prac2:
    ...
    # set up handler to look after randomisation of conditions etc
    trials_practice = data.TrialHandler(nReps=99, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=[None],
    ...
    # completed 99 repeats of 'trials_practice'
    
    thisExp.nextEntry()
    
# completed 1 repeats of 'trials_prac2'
