...
expName = 'pilot_v5'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/nursimaunver/Memory ryhthms/ltm-att-exp/pilot_v5.py',
...
for thisTrials_practice in trials_practice:
    ...
    if (degree_difference >180):
        ...
        degre_difference=round(degree_difference)
    polygon.setPos((x, y))
...
for thisSound_loop in sound_loop:
    ...
    # keep track of which components have finished
    feedback2Components = [polygon_outside6, polygon_inside6, text_9]
