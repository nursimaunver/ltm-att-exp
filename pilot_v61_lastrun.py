...
expName = 'pilot_v61'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/nursimaunver/Memory ryhthms/ltm-att-exp/pilot_v61_lastrun.py',
...
# set up handler to look after randomisation of conditions etc
trials_prac2 = data.TrialHandler(nReps=999, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('cond.xlsx'),
...
for thisTrials_prac2 in trials_prac2:
    ...
    trials_practice = data.TrialHandler(nReps=1, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('cond.xlsx', selection=[current_trial_num]),
    ...
    for thisTrials_practice in trials_practice:
        ...
        if len(row_list) == 0:
            trials_prac2.finished = True # all trials complete
        else:
...
# completed 999 repeats of 'trials_prac2'
