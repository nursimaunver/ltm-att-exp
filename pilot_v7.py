...
expName = 'pilot_v7'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/nursimaunver/Memory ryhthms/ltm-att-exp/pilot_v7.py',
...
# set up handler to look after randomisation of conditions etc
trials_prac2 = data.TrialHandler(nReps=100, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=[None],
...
# completed 100 repeats of 'trials_prac2'
