...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/nursimaunver/Memory ryhthms/ltm-att-exp/retrieval_lastrun.py',
...
sound_2 = sound.Sound('A', secs=1.5, stereo=True, hamming=False,
    name='sound_2')
sound_2.setVolume(1)
...
for thisExp_loop in exp_loop:
    ...
    sound_1.setSound(sounds1, hamming=True)
    ...
    while continueRoutine:
        ...
        # *dual_resp1* updates
        waitOnFlip = False
        if dual_resp1.status == NOT_STARTED and tThisFlip >= 0.2-frameTolerance:
            # keep track of start time/frame for later
    ...
    continueRoutine = True
    # update component parameters for each repeat
    sound_2.setSound(sounds2, secs=1.5, hamming=False)
