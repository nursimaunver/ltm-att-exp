...
let expName = 'pilot_v3';  // from the Builder filename that created this script
...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'distractors/2radio4.png', 'path': 'distractors/2radio4.png'},
    ...
    {'name': 'distractors/3vantilatör4.png', 'path': 'distractors/3vantilatör4.png'},
    ...
    {'name': 'distractors/3gardenswing6.png', 'path': 'distractors/3gardenswing6.png'},
    ...
    {'name': 'distractors/3tent7.png', 'path': 'distractors/3tent7.png'},
    ...
    {'name': 'distractors/3bed3.png', 'path': 'distractors/3bed3.png'},
    ...
    {'name': 'condFile.xlsx', 'path': 'condFile.xlsx'},
    ...
    {'name': 'filler.xlsx', 'path': 'filler.xlsx'},
