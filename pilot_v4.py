...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/nursimaunver/Memory ryhthms/ltm-att-exp/pilot_v4.py',
...
for thisTrials_practice in trials_practice:
    ...
    import math
    resp_degree = math.atan2(y,x)/math.pi*180
    actual_degree = math.atan2(object_location_y,object_location_x)/math.pi*180
    degree_difference = resp_degree - actual_degree
    # keep track of which components have finished
